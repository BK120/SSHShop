...
<script>
	...
	function checkUserNameByAjax() {
		...
		//JQuery的方式校验
		$.ajax({
					url : "${pageContext.request.contextPath}/user_findByName.action?time="
							...
							<tbody>
								<tr>
									...
									<td><input type="text" id="username" name="username"
										class="text" maxlength="20" onblur="checkUserNameByAjax()" />
								...
								<tr>
									...
									<td><input type="password" id="repassword"
										...
										autocomplete="off" /> <span><s:fielderror
												fieldName="repassword" /></span></td>
								</tr>
								<tr>
								...
								<tr>
									<th>地址:</th>
									<td><input type="text" name="attr" class="text"
										maxlength="200" /> <span><s:fielderror
								...
								<tr>
									...
									<td><span class="fieldSet"> <input type="text"
											...
											maxlength="4" autocomplete="off" /><img id="checkImage"
											class="captchaImage"
											src="${pageContext.request.contextPath}/checkImg.action"
											title="点击更换验证码" onclick="changeCheckCodeImg()"/>
											<div>
												<s:actionerror />
											</div></span></td>
								</tr>
