...
<HTML>
	...
	<body>
	<!-- Struts2表单上传必须满足 post提交  上传input具有name属性  表单具有enctype="multipart/form-data" -->
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
						商品名称：<s:property value="model.pid"/>
					</td>
					<td class="ta_01" bgColor="#ffffff" >
						<input type="text" name="pname"  class="bg" value="<s:property value="model.pname"/>"/>
					</td>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
						所属的二级分类：
					</td>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" >
						<input type="text" name="market_price"  class="bg" value="<s:property value="model.market_price"/>"/>
					</td>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
						商品商城价格：
					</td>
					<td class="ta_01" bgColor="#ffffff" >
						<input type="text" name="shop_price"  class="bg" value="<s:property value="model.shop_price"/>"/>
					</td>
				</tr>
				<tr>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<textarea rows="5" cols="40" name="pdesc"><s:property value="model.pdesc"/></textarea>
