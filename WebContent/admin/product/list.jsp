						...
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<s:iterator var="product" value="pageBean.list" status="status">
								<tr onmouseover="this.style.backgroundColor = '#facd89'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="17%"><img alt="商品图片" width="60" height="45"
										src="${pageContext.request.contextPath}/<s:property value="#product.image" />" /></td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="17%"><s:property value="#product.pname" /></td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="17%"><s:property value="#product.shop_price" /></td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="17%"><s:if test="#product.is_hot==1">
										是
										</s:if>
										<s:else>
										否
					...
					<td class="ta_01" align="center" bgColor="#afd1f3">第<s:property
						...
						&nbsp;&nbsp;&nbsp; <s:if test="pageBean.page !=1">
							...
							<s:if test="pageBean.page != #i">
								<a
									href="${pageContext.request.contextPath }/adminProduct_findAll.action?page=<s:property value="#i"/>"><font
